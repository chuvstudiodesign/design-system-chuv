...
const image1 =
  "https://s2.q4cdn.com/470004039/files/images/executive/2026/Molly_Anderson_bio-png-large_2x.png"
const image2 =
  "https://images.macrumors.com/t/taGuYtv3ljuUrgP59yCCsVZJU-Q=/400x0/article-new/2026/03/MacBook-Neo-Held-Out-x4.jpg?lossy"
const image3 =
  "https://www.apple.com/newsroom/images/2026/03/say-hello-to-macbook-neo/article/Apple-MacBook-Neo-lifestyle-01-260304_big.jpg.large.jpg"

export default function MollyAndersonVpIndustrialDesignPage() {
  return (
    <div className="ds-page">
      <div className="ds-page-header">
        ...
        <h1 className="ds-page-title">Molly Anderson — VP Industrial Design · Apple</h1>
        <p className="ds-page-description">
          Página criada para o post aprovado sobre Molly Anderson, VP de Industrial Design da Apple,
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-foreground">
          Tema aprovado:{" "}
          <strong>
            Molly Anderson — VP de Industrial Design da Apple. Nokia, Barber Osgerby, Apple desde
            2014. A equação de materiais do MacBook Neo.
          </strong>
        </p>
      </div>
      ...
      >
          ...
          {[
            {
              page: "01",
              title: "Cover Hook",
              body: "Foto oficial de Molly Anderson com título e subtítulo aprovados.",
            },
            {
              page: "02",
              title: "Support Page",
              body: "MacBook Neo em mãos — produto que ancora o argumento da copy.",
            },
            {
              page: "03",
            ...
            },
            {
              page: "04",
              title: "Bullet Card",
              body: "Highlight e quatro bullets factuais sobre trajetória e formação.",
            },
            {
              page: "05",
              title: "Closing",
              body: "Fecha com a linha aprovada e lifestyle do MacBook Neo como âncora.",
            },
          ].map((item) => (
            <div
              key={item.page}
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            ...
            <Typography variant="body-s" className="text-muted-foreground">
              Foto oficial abre a capa. MacBook Neo em mãos ancora a página 2. Lifestyle fecha
              na página 5.
            </Typography>
          </div>
        </div>
      ...
      >
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                ...
                <PostImage src={image1} alt="Molly Anderson — foto oficial Apple" fill />

                <div className="min-w-0">
                  <Typography variant="h1" className="max-w-[10ch] leading-[0.92]">
                    Menos material. O mesmo MacBook.
                  </Typography>
                  <Typography variant="body-s" className="mt-3 max-w-[29ch] text-muted-foreground">
                    Molly Anderson é a nova VP de Industrial Design da Apple. E já tem muito a mostrar.
                  </Typography>
                </div>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <PostImage src={image2} alt="MacBook Neo — em mãos" />

                <PostCard>
                  <Typography variant="h4">
                    O MacBook Neo custa $599. Não porque usou menos qualidade.
                  </Typography>
                  <Typography variant="body-s" className="mt-3 text-muted-foreground">
                    Porque usou menos material.
                  </Typography>
                </PostCard>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <div className="flex items-center justify-between gap-3">
                  <Badge variant="tool">Industrial Design</Badge>
              ...
              <SocialPageFrame>
                ...
                <PostCard>
                  <div className="space-y-3">
                    {(
                      [
                        { label: "Nokia, Barber Osgerby", Icon: Rocket },
                        { label: "Apple desde 2014", Icon: User },
                        { label: "Loughborough + RCA", Icon: BookOpen },
                        { label: "MacBook Neo", Icon: Laptop },
                      ] as const
                    ).map(({ label, Icon }) => (
              ...
              <SocialPageFrame>
                ...
                <div className="min-w-0">
                  <Typography variant="h3" className="max-w-[16ch] leading-[0.94]">
                    Design industrial como equação, não como concessão.
                  </Typography>
                </div>

                <PostImage src={image3} alt="MacBook Neo — lifestyle" fill />
              </SocialPageFrame>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
            <p>Page 1 usa a foto oficial de Molly Anderson aprovada para este post.</p>
            <p>Page 2 usa a imagem do MacBook Neo em mãos aprovada para este post.</p>
            <p>Page 5 usa o lifestyle do MacBook Neo aprovado para este post.</p>
          </div>
        </div>
      </Section>
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame45>
                ...
                <PostImage src={image2} alt="MacBook Neo — em mãos" fill />
              </SocialPageFrame45>
            </div>
