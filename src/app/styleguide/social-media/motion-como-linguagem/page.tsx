...
const image1 =
  "https://mir-s3-cdn-cf.behance.net/project_modules/source/a5f3a9110833657.5ff6424105db6.gif"
const image2 =
  "https://miro.medium.com/v2/resize:fit:1400/1*cXnMmJ49yCI1JII9MnlZ0Q.gif"
const image3 =
  "https://blog.tubikstudio.com/wp-content/uploads/2016/10/page-indicator-animation-tubikstudio.gif"

export default function MotionComoLinguagemPage() {
  return (
    <div className="ds-page">
      <div className="ds-page-header">
        ...
        <h1 className="ds-page-title">Motion como linguagem</h1>
        <p className="ds-page-description">
          Página criada para o post aprovado sobre motion design como sistema de comunicação,
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-foreground">
          Tema aprovado:{" "}
          <strong>
            Motion como linguagem — quando a animação deixa de ser detalhe e passa a comunicar
            hierarquia
          </strong>
        </p>
      </div>
      ...
      >
          ...
          {[
            {
              page: "01",
              title: "Cover Hook",
              body: "Título e subtítulo aprovados com GIF de motion design editorial na capa.",
            },
            {
              page: "02",
              title: "Support Page",
              body: "GIF de transição de hierarquia reforça o argumento visual da copy.",
            },
            {
              page: "03",
            ...
            },
            {
              page: "05",
              title: "Closing",
              body: "Fecha com a linha aprovada e GIF de animação de interface como âncora visual.",
            },
          ].map((item) => (
            <div
              key={item.page}
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            ...
            <Typography variant="body-s" className="text-muted-foreground">
              Os GIFs são puxados por URL pública a partir das referências aprovadas.
            </Typography>
          </div>
        </div>
      </Section>
      ...
      >
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                ...
                <PostImage src={image1} alt="Motion design com curvas de easing" fill />

                <div className="min-w-0">
                  <Typography variant="h1" className="max-w-[14ch] leading-[0.92]">
                    Animação que pensa antes de se mover
                  </Typography>
                  <Typography variant="body-s" className="mt-3 max-w-[29ch] text-muted-foreground">
                    Quando motion vira linguagem, hierarquia deixa de depender de layout.
                  </Typography>
                </div>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <PostImage src={image2} alt="Transição de hierarquia em interface" />

                <PostCard>
                  <Typography variant="h4">
                    Os melhores sistemas de motion não decoram — eles orientam
                  </Typography>
                  <Typography variant="body-s" className="mt-3 text-muted-foreground">
                    Direção é argumento visual.
                  </Typography>
                </PostCard>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <div className="flex items-center justify-between gap-3">
                  <Badge variant="tool">Motion</Badge>
              ...
              <SocialPageFrame>
                ...
                <PostCard>
                  <div className="space-y-3">
                    {(
                      [
                        { label: "Sequência", Icon: Layers2 },
                        { label: "Peso", Icon: Weight },
                        { label: "Direção", Icon: MoveRight },
                        { label: "Tempo", Icon: Timer },
                      ] as const
                    ).map(({ label, Icon }) => (
              ...
              <SocialPageFrame>
                ...
                <div className="min-w-0">
                  <Typography variant="h3" className="max-w-[16ch] leading-[0.94]">
                    Se o usuário não vê a lógica, o motion falhou.
                  </Typography>
                </div>

                <PostImage src={image3} alt="Animação de indicador de página" fill />
              </SocialPageFrame>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
            <p>Page 1 usa o GIF de motion design com curvas de easing aprovado para este post.</p>
            <p>Page 2 usa o GIF de transição de hierarquia em interface aprovado para este post.</p>
            <p>Page 5 usa o GIF de animação de indicador de página aprovado para este post.</p>
          </div>
        </div>
      </Section>
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame45>
                ...
                <PostImage src={image2} alt="Transição de hierarquia em interface" fill />
              </SocialPageFrame45>
            </div>
