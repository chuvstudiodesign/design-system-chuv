...
const image1 =
  "https://www.carscoops.com/wp-content/uploads/2026/02/Ferrari-Feb9261-copy-1024x576.jpg"
const image2 =
  "https://cdn.mos.cms.futurecdn.net/fn4xvRMmhWpVomtsboVNWW.gif"
const image3 =
  "https://cdn.mos.cms.futurecdn.net/VGwHqsW6vnMCYvh84G2tAa.gif"

export default function LoveFromFerrari5AnosPage() {
  return (
    <div className="ds-page">
      <div className="ds-page-header">
        ...
        <h1 className="ds-page-title">LoveFrom + Ferrari — 5 anos, um interior</h1>
        <p className="ds-page-description">
          Página criada para o post aprovado sobre a parceria entre LoveFrom e Ferrari,
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-foreground">
          Tema aprovado:{" "}
          <strong>
            LoveFrom + Ferrari — 5 anos de parceria, um interior: o que significa construir algo
            tão preciso por tanto tempo antes de mostrar qualquer coisa
          </strong>
        </p>
      </div>
      ...
      >
          ...
          {[
            {
              page: "01",
              title: "Cover Hook",
              body: "Título e subtítulo aprovados com foto do interior do Luce na capa.",
            },
            {
              page: "02",
              title: "Support Page",
              body: "GIF editorial reforça a filosofia físico vs. digital da copy aprovada.",
            },
            {
              page: "03",
            ...
            },
            {
              page: "05",
              title: "Closing",
              body: "Fecha com as duas linhas aprovadas e GIF do interior como âncora visual.",
            },
          ].map((item) => (
            <div
              key={item.page}
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            ...
            <Typography variant="body-s" className="text-muted-foreground">
              A foto do cockpit está na capa. Os GIFs editoriais reforçam o argumento nas páginas
              seguintes.
            </Typography>
          </div>
        </div>
      ...
      >
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                ...
                <PostImage src={image1} alt="Interior do Ferrari Luce" fill />
                ...
                <div className="min-w-0">
                  ...
                  <Typography variant="body-s" className="mt-3 max-w-[29ch] text-muted-foreground">
                    O que a LoveFrom construiu com a Ferrari desde 2021.
                  </Typography>
                </div>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <PostImage src={image2} alt="LoveFrom Ferrari editorial" />

                <PostCard>
                  <Typography variant="h4">
                    Físico para o essencial. Digital para o resto.
                  </Typography>
                  <Typography variant="body-s" className="mt-3 text-muted-foreground">
                    Clima, volante, lançamento — tudo em botão.
                  </Typography>
                </PostCard>
              </SocialPageFrame>
            </div>
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame>
                <div className="flex items-center justify-between gap-3">
                  <Badge variant="tool">LoveFrom</Badge>
                ...
                <div className="flex flex-1 flex-col justify-center min-w-0">
                  <Typography
                    variant="display-l"
                    className="max-w-[12ch] text-balance leading-[0.9]"
                  >
                    Toque só onde os olhos podem seguir.
                  </Typography>
                </div>
              </SocialPageFrame>
            </div>
              ...
              <SocialPageFrame>
                ...
                <PostCard>
                  <div className="space-y-3">
                    {(
                      [
                        { label: "Volante em 19 peças CNC", Icon: Cog },
                        { label: "OLED que pivota entre dois", Icon: RotateCcw },
                        { label: "Chave em Gorilla Glass", Icon: KeyRound },
                        { label: "Nardi nos anos 60", Icon: History },
                      ] as const
                    ).map(({ label, Icon }) => (
              ...
              <SocialPageFrame>
                ...
                <div className="min-w-0">
                  <Typography variant="h3" className="max-w-[16ch] leading-[0.94]">
                    A Luce não rejeitou a tela. Renegociou o papel dela.
                  </Typography>
                </div>

                <PostImage src={image3} alt="Ferrari Luce interior detail" fill />

                <Typography variant="body-s" className="text-muted-foreground">
                  Isso é o que 5 anos de processo entregam.
                </Typography>
              </SocialPageFrame>
            </div>
          </div>
        ...
        <div className="mt-6 rounded-none border border-white bg-[#f9f9f9] p-[var(--card-padding)]">
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
            <p>Page 1 usa a foto do cockpit do Ferrari Luce aprovada para este post.</p>
            <p>Page 2 usa o GIF editorial LoveFrom/Ferrari aprovado para este post.</p>
            <p>Page 5 usa o GIF de detalhe do interior do Luce aprovado para este post.</p>
          </div>
        </div>
      </Section>
          ...
          <div className="flex min-w-max gap-4">
            ...
            <div className="w-[320px] shrink-0">
              <SocialPageFrame45>
                ...
                <PostImage src={image2} alt="LoveFrom Ferrari editorial" fill />
              </SocialPageFrame45>
            </div>
