...
const NS = "portfolio-midia-mobile"
...
export default function PortfolioMidiaMobilePage() {
  ...
  return (
    <div className="ds-page">
      ...
      {/* ── S1 — Disciplinas ──────────────────────────────────────────────── */}
      <section ref={areasRef} className={`${MOBILE_SECTION} bg-[#efefef]`}>
        <div className="mb-[45px] flex flex-col items-center text-center">
          <Typography variant="h1" className="max-w-3xl">
      ...
      <section className={`${MOBILE_SECTION} bg-[#efefef]`}>
        <div className="mb-[45px] flex flex-col items-center text-center">
          <Typography variant="h1" className="max-w-3xl">
      ...
      <section className={`${MOBILE_SECTION} bg-[#000000]`}>
        <div className="mb-[45px] flex flex-col items-center text-center">
